    ...
    <div name="contact" className="w-full h-screen bg-gradient-to-b from-black to-gray-800 text-white">
        <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto md:mx-20 h-full">
            <div className=" pb-4">
                ...
                <p className="py-4">{t('contact_subheader')}</p>
            </div>
            ...
            <div className="flex justify-center items-center"> 
                ...
                >
                    ...
                    className="my-4 p-1 bg-transparent border-2 rounded-md text-white focus:outline-none"
                    />
                    <textarea name="message" rows="7" placeholder={t('contact_message')} 
                        className="p-1 bg-transparent border-2 rounded-md text-white focus:outline-none"
                    ></textarea>

                    <button className="group text-white bg-gradient-to-b from-green-500 to-green-900 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300">
                    {t('contact_send')}
                        <span 
